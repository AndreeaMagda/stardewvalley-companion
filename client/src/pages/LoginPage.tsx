    ...
    <div className="min-h-screen bg-cream flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-muted text-sm mt-1">Sign in to save your progress across sessions.</p>
        </div>

        <button
          onClick={signIn}
          className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-parchment rounded-xl text-sm font-medium text-ink hover:bg-cream transition-colors"
        >
